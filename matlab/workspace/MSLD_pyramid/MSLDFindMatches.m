function [line_segment_matches,elapsed_time] = MSLDFindMatches(I1,I2,path_of_desc, path_of_match,Options)
...
[lines1_tmp,scales1_tmp] = generateLineFileFunction(I1,[path,save_name1_txt], size(I1,1),size(I1,2),Options);
[lines2_tmp,scales2_tmp] = generateLineFileFunction(I2,[path,save_name2_txt], size(I2,1),size(I2,2),Options);
...
%disp([path_of_desc,' ',save_name1_img, ' ',save_name2_img,' ', save_name1_txt,' ', save_name2_txt,' ',save_name_result]);
