...
[result,elapsed_time] = MSLDFindMatches(I1,I2,path_of_exe, Options);
...
fprintf(1,'\n*** Image 1 vs 3 ***\n');
fprintf(fid,'\n*** Image 1 vs 3 ***\n');
[result,elapsed_time] = MSLDFindMatches(I1,I3,path_of_exe,Options);
fprintf('Elapsed time: %f s\n',elapsed_time);
...
fprintf(1,'\n*** Image 1 vs 5 ***\n');
fprintf(fid,'\n*** Image 1 vs 5 ***\n');
[result,elapsed_time] = MSLDFindMatches(I1,I5,path_of_exe,Options);
fprintf('Elapsed time: %f s\n',elapsed_time);
...
[result,elapsed_time] = MSLDFindMatches(I1,I6,path_of_exe,Options);
fprintf('Elapsed time: %f s\n',elapsed_time);
